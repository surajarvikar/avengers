                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-lg-10 mx-auto">
                            <div className="row">
                                {/* left side start */}
                                <div className="contact-left-side col-12 col-lg-5 " data-aos="fade-right"   data-aos-delay="300">
                                    <h1 className="main-heading fw-bold">Connect With Our <br /> Avengers Team.</h1>
                                    ...
                                    <img src="./Images/avenger-3.jpg" alt="contact-us-img" className="img-fluid" />
                                </div>
                                {/* left side end */}
                                {/* right side start */}
                                <div className="col-12 col-lg-7 contact-right-side" data-aos="fade-left"   data-aos-delay="500">
                                    <form method="POST">
                                        <div className="row">
                                            ...
                                            <div className="form-check form-checkbox-style">
                                                ...
                                                <label class="form-check-label" className="main-hero-para">I agree that the Avengers may contact you at the email address or phone number above.</label>
